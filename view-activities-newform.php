    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="post" action="">
          <div class="mb-3">
            <label for="aName" class="form-label">Activity Name</label>
            <input type="text" class="form-control" id="aName" name="aName">
          </div>
          <div class="mb-3">
            <label for="aType" class="form-label">Activity Type</label>
            <input type="text" class="form-control" id="aType" name="aType">
          </div>
          <div class="mb-3">
            <label for="aCost" class="form-label">Cost</label>
            <input type="text" class="form-control" id="aCost" name="aCost">
          </div>
